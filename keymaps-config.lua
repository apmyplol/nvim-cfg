...
keymap("n", "<C-w>", "<cmd> lua MiniBufremove.delete()<cr>", opts)
-- keymap("n", "s", "<Plug>Lightspeed_s", opts)

-- b / B beginning of previous / next word
-- W / w end of previous / next word
keymap("n", "B", "w", opts)
keymap("n", "W", "gE", opts)
keymap("n", "w", "e", opts)
...
keymap("i", "<C-k>", "<cmd>lua require 'keymapfunctions'.luasnipchoose(-1)<cr>", opts)
keymap("i", "<C-j>", "<cmd>lua require 'keymapfunctions'.luasnipchoose(1)<cr>", opts)
