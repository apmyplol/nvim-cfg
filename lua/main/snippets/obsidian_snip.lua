...
ls.add_snippets("obsidian", {
    ...
    s_nomath("def", { t "> [!important]+ ", i(1, "Definition"), t { "", "> " }, i(0) }),
    s_nomath("rem", { t "> [!info]+ Bemerkung ", i(1, "Bemerkung"), t { "", "> " }, i(0) }),
    s_nomath("warning", { t "> [!warning]+ ", i(1), t { "", "> " }, i(0) }),
    s_nomath("quote", { t "> [!quote]+ ", i(1), t { "", "> " }, i(0) }),
    s_nomath("satz", { t "> [!abstract]+ ", i(1), t { "", "> " }, i(0) }),
    s_nomath("problem", { t "> [!warning]+ ", i(1), t { "", "> " }, i(0) }),
    s_nomath("con", { t "> [!error]+ ", i(1, "cons"), t { "", "> " }, i(0) }),
    s_nomath("pro", { t "> [!check]+ ", i(1, "pros"), t { "", "> " }, i(0) }),
